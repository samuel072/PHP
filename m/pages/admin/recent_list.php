...
<body>
  ...
  <div class="act_list">
    ...
    <?php foreach($recent_list as $activity) { ?>
    <ul>
	...
	<!--	<a href="/m/admin.php?mod=edit_activity&act_id=" target="mainFrame">编辑</a> | -->
		<?php
  ...
  <div class="buttons">
    <a href="/m/admin.php?mod=edit_activity" target="mainFrame">添加预告</a>
  </div>
