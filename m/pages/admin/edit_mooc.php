    ...
    <form method="post" enctype="multipart/form-data">
     ...
     <!--    <li>
          ...
          <label class="field_value">
            <input id="input_guest_name" type="text" name="guest_name" class="txt_in" value="<?php echo $mooc->guest_name; ?>"/>
          </label>
        </li>  

        <li class="image">
          <label class="field_value">
            <img id="img_avatar" src="<?php echo $mooc->guest_avatar; ?>" width="80"/>
          </label>
        </li>  
        ...
        <li>
          ...
          <label class="field_value">
            <input id="input_guest_intro" type="text" name="guest_intro" class="txt_in" value="<?php echo $mooc->guest_intro; ?>"/>
          </label>
        </li>-->

        <li>
          <label class="field_comment">公开课标题(必填)：</label>
          <label class="field_value">
            <input id="input_title" type="text" name="title" class="txt_in" value="<?php echo $mooc->title; ?>" />
          </label>
        </li>
				
        <li class="act_txt_area">
          <label class="field_comment">课程介绍(必填)：</label>
          <label class="field_value">
            <textarea id="input_summary" name="summary" maxlength="100" ><?php echo $mooc->summary; ?></textarea>
        ...
        <li class="bigimage">
          <label class="field_value">
            <img id="img_cover" class="bigimage" src="<?php echo $mooc->thumbnail; ?>"/>
          </label>
        </li>

        <li>
          <label class="field_comment">公开课视频封面(640*480)：</label>
          <label class="field_value">
        ...
        <li>
          ...
          <label class="field_value">
            <input id="input_author" type="text" readonly="readonly" name="author_id" class="txt_in stop_in" value="<?php echo $mooc->author->name;?>" />
          </label>
        </li>
...
<!--		<li>
			...
			<?php foreach($tag_list as $tag) { ?>
				<label class="field_value fv_tag">
					<input id="input_tag<?php echo $tag->id;?>" type="checkbox" name="checkbox" class="txt_check_box" value="<?php echo $tag->id;?>" <?php if($mooc->id){foreach($mooc->tags as $mooc_tag){if($mooc_tag->id == $tag->id){echo "checked='checked'";}}}?> /><?php echo $tag->name; ?>	
				</label>
			<?php }?>
        </li>-->
      <!--  <li>
          ...
          <label class="field_value">
            <input id="input_start_time" type="text" name="start_time" class="txt_in" value="<?php echo $mooc->start_time; ?>"/>
          </label>
        </li>
        ...
        <li>
          ...
          <label class="field_value">
            <input id="input_end_time" type="text" name="end_time" class="txt_in" value="<?php echo $mooc->end_time; ?>"/>
          </label>
        </li>
        ...
        <li>
          ...
          <label class="field_value">
            <input id="input_address" type="text" name="address" class="txt_in" value="<?php echo $mooc->address; ?>"/>
          </label>
        </li>
        ...
        <li>
          ...
          <label class="field_value">
            <input id="input_holder" type="text" name="holder" class="txt_in" value="<?php echo $mooc->holder; ?>"/>
          </label>
        </li>  -->
        ...
        <li>
          ...
          <label class="field_value">
            <input id="input_seo_alt" type="text" name="seo_alt" class="txt_in" value="<?php echo $mooc->seo_alt; ?>"/>
          </label>
        </li>
        ...
        <li>
          ...
          <label class="field_value">
            <input id="input_seo_title" type="text" name="seo_title" class="txt_in" value="<?php echo $mooc->seo_title; ?>" />
          </label>
        </li>
        ...
        <li>
          ...
          <label class="field_value">
            <input id="input_seo_keywords" type="text" name="seo_keywords" class="txt_in" value="<?php echo $mooc->seo_keywords; ?>"/>
          </label>
        </li>
        ...
        <li>
          ...
          <label class="field_value">
            <input id="input_seo_keywords" readonly=readonly type="text" name="preview" class="txt_in" value="/m/mooc/detail.php?id=<?php echo $mooc->id; ?>"/>
          </label>
        </li>
      </ul>
...
<?php if($mooc->id){ ?>
  <div id="mooc_content" class="content">
    <?php foreach($mooc->content as $section) { ?>
...
<?php }?>
  ...
  <script type="text/javascript">
      ...
      html = "<div id='section_new_section' class='section section_text'>" +
               "<ul>" +
                 ...
                 "<li>" +
                   "<label class='field_comment'>段落序号：</label>" +
                   "<label class='field_value'>" +
                     "<input type='text' name='num' class='txt_in' value='<?php echo count($mooc->content); ?>'/>" +
                   "</label>" +
                 "</li>" +
               "</ul>" +
               "<div class='toolbar toolbar_little'>" +
    ...
    function save_text_section(sec_id) {
      ...
      save_section(secid, 0, detail, '', '', <?php echo $mooc->id; ?>, '', num);
    }
    ...
    function save_title_section(sec_id) {
      ...
      save_section(secid, 4, detail, '', '', <?php echo $mooc->id; ?>, '', num);
    }
    ...
    function save_link_section(sec_id) {
      ...
      var num = $('#section_' + sec_id).find("input[name='num']").val();
      save_section(secid, 2, detail, '', '', <?php echo $mooc->id; ?>, link, num);
    }
    ...
    function save_image_section(sec_id) {
      ...
      var num = $('#section_' + sec_id).find("input[name='num']").val();
      save_section(secid, 1, detail, path, alt, <?php echo $mooc->id; ?>, '', num);
    }
    ...
    function save_video_section(sec_id) {
      ...
      var link = $('#section_' + sec_id).find("input[name='link']").val();
      var num = $('#section_' + sec_id).find("input[name='num']").val();
      save_section(secid, 3, detail, path, alt, <?php echo $mooc->id; ?>, link, num);
    }
  ...
  <script type="text/javascript">
    function upload_image(file, img_tag) {
      $.ajaxFileUpload({
        ...
        error: function(s, xhr, status, last) {
            alert("error");
        }
      });
  ...
  <script type="text/javascript">
    function save_talk() {
      ...
      var json_array = { <?php if($mooc->id) { echo "id : " . $mooc->id . ","; } ?>
                         "type" : <?php echo $mooc->type; ?>,
      ...
      $.ajax({
        ...
        contentType:'application/json',
        success:function(data) {
          window.location.href = "/m/admin.php?mod=mooc&next_id=0&count=10";
        },
        error:function(xhr, msg, obj) {
          alert(msg);
        }
  ...
  <script type="text/javascript">
	...
	$("#input_summary").keyup(function() {
		...
		if(summLength>=0 && summLength <= 100){
			...
			// 将该文本冻结 并提示已经超出啦最大值	
			$("#input_summary").attr("readonly", "readonly");
			$(this).blur();
		}
	...
	/*$("#input_guest_intro").keyup(function() {
		...
		if(introLength>0 && introLength <= 60){
			...
			// 将该文本冻结 并提示已经超出啦最大值	
			$("#input_guest_intro").attr("readonly", "readonly");
			$(this).blur();
		}
	});*/
	</script>
