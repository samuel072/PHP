  ...
  <div class="activity">
    <form method="post" enctype="multipart/form-data">
      <ul>
       ...
       <li>
          <label class="field_comment">活动嘉宾姓名(选填)：</label>
          <label class="field_value">
            <input id="input_guest_name" type="text" name="guest_name" class="txt_in" value="<?php echo $activity->guest_name; ?>"/>
          </label>
        </li> 

      <!--   <li class="image">
          <label class="field_value">
            <img id="img_avatar" src="<?php echo $activity->guest_avatar; ?>" width="80"/>
          </label>
        </li>

        <li>
          <label class="field_comment">嘉宾头像(选填)：</label>
          <label class="field_value">
        ...
        <li class="intro_li">
          <label class="field_comment">活动嘉宾介绍(选填)：</label>
          <label class="field_value">
            <input id="input_guest_intro" type="text" name="guest_intro" class="txt_in" value="<?php echo $activity->guest_intro; ?>"/>
        ...
        <li>
          ...
          <label class="field_value">
            <input id="input_title" type="text" name="title" class="txt_in" value="<?php echo $activity->title; ?>" />
          </label>
        </li>
        ...
        <li class="act_txt_area">
          ...
          <label class="field_value">
            <textarea id="input_summary" name="summary" maxlength="100" ><?php echo $activity->summary; ?></textarea>
       ...
       <li class="bigimage">
          <label class="field_value">
            <img id="img_cover" class="bigimage" src="<?php echo $activity->thumbnail; ?>"/>
          </label>
        </li>

        <li>
          <label class="field_comment">活动封面(640*480)：</label>
          <label class="field_value">
        ...
        <li>
          <label class="field_comment">作者(必填)：</label>
          <label class="field_value">
            <input id="input_author" type="text" readonly="readonly" name="author_id" class="txt_in stop_in" value="<?php echo $activity->author->name;?>" />
          </label>
		</li>
		...
		<li>
          ...
          <label class="field_value">
            <input id="input_position" type="text" name="position" class="txt_in txt_w" value="<?php echo $activity->position;?>" width="1
00"/>(值越大，越靠前)
          </label>
        </li>
		...
		<li>
			...
			<?php foreach($tag_list as $tag) { ?>
				<label class="field_value fv_tag">
					<input id="input_tag<?php echo $tag->id;?>" type="checkbox" name="checkbox" class="txt_check_box" value="<?php echo $tag->id;?>" <?php if($activity->id){foreach($activity->tags as $activity_tag){if($activity_tag->id == $tag->id){echo "checked='checked'";}}}?> /><?php echo $tag->name; ?>	
				</label>
			<?php }?>
        </li>
	
		<li>
			<label class="field_comment">是否可以报名：</label>
			<label class="field_value">
				<select name="allow" id="s_allow">
					<option value="0" <?php if($activity->allow == 0){echo 'selected=selected';}?> >不允许报名</option>
					<option value="1" <?php if($activity->allow == 1){echo 'selected=selected';}?> >允许报名</option>
				</select>
			</label>
        </li>

		<li>
			<label class="field_comment">是否免费：</label>
			<label class="field_value">
				<select name="is_free" id="is_free">
					<option value="0" <?php if($activity->is_free == 0){echo 'selected=selected';}?> >免费</option>
					<option value="1" <?php if($activity->is_free == 1){echo 'selected=selected';}?> >收费</option>
				</select>
			</label>
        </li>

        <li>
          <label class="field_comment">报名的链接(必填)</label>
          <label class="field_value">
            <input id="input_link" type="text" name="link" class="txt_in" value="<?php echo $activity->link; ?>" />
          </label>
        </li>
		 ...
		 <li>
          ...
          <label class="field_value">
            <input id="input_start_time" type="text" name="start_time" class="txt_in" value="<?php echo $activity->start_time; ?>"/>
          </label>
        </li>
        ...
        <li>
          ...
          <label class="field_value">
            <input id="input_end_time" type="text" name="end_time" class="txt_in" value="<?php echo $activity->end_time; ?>"/>
          </label>
        </li>
        ...
        <li>
          ...
          <label class="field_value">
            <input id="input_address" type="text" name="address" class="txt_in" value="<?php echo $activity->address; ?>"/>
          </label>
        </li>
        ...
        <li>
          ...
          <label class="field_value">
            <input id="input_holder" type="text" name="holder" class="txt_in" value="<?php echo $activity->holder; ?>"/>
          </label>
        </li>
        ...
        <li>
          ...
          <label class="field_value">
            <input id="input_seo_alt" type="text" name="seo_alt" class="txt_in" value="<?php echo $activity->seo_alt; ?>"/>
          </label>
        </li>
        ...
        <li>
          ...
          <label class="field_value">
            <input id="input_seo_title" type="text" name="seo_title" class="txt_in" value="<?php echo $activity->seo_title; ?>" />
          </label>
        </li>
        ...
        <li>
          ...
          <label class="field_value">
            <input id="input_seo_keywords" type="text" name="seo_keywords" class="txt_in" value="<?php echo $activity->seo_keywords; ?>"/>
          </label>
        </li>
        ...
        <li>
          ...
          <label class="field_value">
            <input id="input_seo_keywords" readonly=readonly type="text" name="preview" class="txt_in" value="/activity/detail.php?id=<?php echo $activity->id; ?>"/>
          </label>
        </li>
      </ul>
...
<?php } ?>
  ...
  <script type="text/javascript">
      ...
      html = "<div id='section_new_section' class='section section_text'>" +
               "<ul>" +
                 ...
                 "<li>" +
                   "<label class='field_comment'>段落序号：</label>" +
                   "<label class='field_value'>" +
                     "<input type='text' name='num' class='txt_in' value='<?php echo count($activity->content); ?>'/>" +
                   "</label>" +
                 "</li>" +
               "</ul>" +
               "<div class='toolbar toolbar_little'>" +
    ...
    function save_text_section(sec_id) {
      ...
      save_section(secid, 0, detail, '', '', <?php echo $activity->id; ?>, '', num);
    }
    ...
    function save_title_section(sec_id) {
      ...
      save_section(secid, 4, detail, '', '', <?php echo $activity->id; ?>, '', num);
    }
    ...
    function save_link_section(sec_id) {
      ...
      var num = $('#section_' + sec_id).find("input[name='num']").val();
      save_section(secid, 2, detail, '', '', <?php echo $activity->id; ?>, link, num);
    }
    ...
    function save_image_section(sec_id) {
      ...
      var num = $('#section_' + sec_id).find("input[name='num']").val();
      save_section(secid, 1, detail, path, alt, <?php echo $activity->id; ?>, '', num);
    }
    ...
    function save_video_section(sec_id) {
      ...
      var link = $('#section_' + sec_id).find("input[name='link']").val();
      var num = $('#section_' + sec_id).find("input[name='num']").val();
      save_section(secid, 3, detail, path, alt, <?php echo $activity->id; ?>, link, num);
    }
  ...
  <script type="text/javascript">
	...
	if(check()){
      ...
      var json_array = { <?php if($activity->id) { echo "id : " . $activity->id . ","; } ?>
                         "type" : <?php echo $activity->type; ?>,
						 ...
						 "allow": $("#s_allow").find("option:selected").val(),
      ...
      $.ajax({
        ...
        contentType:'application/json',
        success:function(data) {
          window.location.href = "/m/admin.php?mod=activity&next_id=0&count=10";
        },
        error:function(xhr, msg, obj) {
          alert(msg);
        }
