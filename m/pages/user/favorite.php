...
<body>
  <div class="body_recent">
    ...
    <div class="body_dixv_recent_talk" >
      ...
      <div class="content_white_activity">
        <div class="content_div_activity">
          ...
          <p class="con_summary_activity"><?php echo date("Y年m月d日 H点i分", strtotime($act->start_time)) ?> 至 <?php  echo date('m月d日 H点i分', strtotime($act->end_time)); ?></p>
    ...
    //滚动条到达底部100像素时候
		...
		function loadMessage(){
			...
			if(num == 0){
				...
				?>
				$.ajax({
					url:"/m/api/user.php?mod=favorite&next_id="+next_id+"&count=10&user_id="+user_id,
					type:"get",
					dataType:"json",
